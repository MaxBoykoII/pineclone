...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _Ng2Bs3ModalModule_3:import5.Ng2Bs3ModalModule;
  ...
  __Http_38:any;
  __PictureService_39:import26.PictureService;
  __AuthService_40:import27.AuthService;
  ...
  get _RootRenderer_24():any {
    if ((this.__RootRenderer_24 == null)) { (this.__RootRenderer_24 = import34._createConditionalRootRenderer(this._DomRootRenderer_23,this.parent.get(import34.NgProbeToken,(null as any)))); }
  ...
  get _ViewUtils_27():import19.ViewUtils {
    if ((this.__ViewUtils_27 == null)) { (this.__ViewUtils_27 = new import19.ViewUtils(this._RootRenderer_24,this._Sanitizer_26)); }
  ...
  get _XSRFStrategy_35():any {
    if ((this.__XSRFStrategy_35 == null)) { (this.__XSRFStrategy_35 = import8._createDefaultCookieXSRFStrategy()); }
  ...
  get _Http_38():any {
    if ((this.__Http_38 == null)) { (this.__Http_38 = import8.httpFactory(this._XHRBackend_36,this._RequestOptions_37)); }
    return this.__Http_38;
  }
  get _PictureService_39():import26.PictureService {
    if ((this.__PictureService_39 == null)) { (this.__PictureService_39 = new import26.PictureService(this._Http_38)); }
    return this.__PictureService_39;
  }
  get _AuthService_40():import27.AuthService {
    if ((this.__AuthService_40 == null)) { (this.__AuthService_40 = new import27.AuthService(this._Http_38)); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import5.Ng2Bs3ModalModule)) { return this._Ng2Bs3ModalModule_3; }
    ...
    if ((token === import36.LOCALE_ID)) { return this._LOCALE_ID_8; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_9; }
    if ((token === import37.ErrorHandler)) { return this._ErrorHandler_10; }
    ...
    if ((token === import39.AnimationDriver)) { return this._AnimationDriver_22; }
    if ((token === import17.DomRootRenderer)) { return this._DomRootRenderer_23; }
    if ((token === import40.RootRenderer)) { return this._RootRenderer_24; }
    if ((token === import18.DomSanitizer)) { return this._DomSanitizer_25; }
    if ((token === import41.Sanitizer)) { return this._Sanitizer_26; }
    if ((token === import19.ViewUtils)) { return this._ViewUtils_27; }
    if ((token === import42.IterableDiffers)) { return this._IterableDiffers_28; }
    if ((token === import43.KeyValueDiffers)) { return this._KeyValueDiffers_29; }
    ...
    if ((token === import26.PictureService)) { return this._PictureService_39; }
    if ((token === import27.AuthService)) { return this._AuthService_40; }
